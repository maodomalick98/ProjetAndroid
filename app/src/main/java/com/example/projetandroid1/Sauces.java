...
public class Sauces extends EpsiActivity {

    String wsUrl="https://djemam.com/epsi/sauces.json";
    ...
    public static void displayActivity(EpsiActivity activity){
        Intent intent = new Intent(activity, Sauces.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WSCall wsCall= new WSCall(wsUrl, new WSCall.Callback() {
            ...
            public void onError(Exception e) {
                Toast.makeText(Sauces.this,e.getMessage(),Toast.LENGTH_LONG).show();
            }
        });
        wsCall.run();
    }
