...
public class Fromage extends EpsiActivity {

    String wsUrl="https://djemam.com/epsi/fromages.json";
    ...
    public static void displayActivity(EpsiActivity activity){
        Intent intent = new Intent(activity, Fromage.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WSCall wsCall= new WSCall(wsUrl, new WSCall.Callback() {
            ...
            public void onError(Exception e) {
                Toast.makeText(Fromage.this,e.getMessage(),Toast.LENGTH_LONG).show();
            }
        });
        wsCall.run();
    }
